    ...
    public void transform(String name, String transformedName, ClassNode node) {
        node.methods.stream()
                ...
                .ifPresent(methodNode -> {
                    ...
                    list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/github/derrop/labymod/addons/emotechat/gui/chat/suggestion/KeyTypedHandler", "blockExecution", "(CI)Z", false));
                    ...
                    methodNode.instructions.insertBefore(labelNode, new FrameNode(Opcodes.F_SAME, 1, null, 0, new LabelNode[]{labelNode}));
                });
    }
