package com.github.emotechat.addon.asm.chat;

import com.github.emotechat.addon.asm.PredicateClassNodeTransformer;
    ...
    public void transform(String name, String transformedName, ClassNode node) {
        ...
        for (MethodNode method : node.methods) {
            if (method.name.equals(methodName) && method.desc.equals(methodDesc)) {
                ...
                list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/github/emotechat/addon/gui/chat/render/ChatWidthCalculator", "calculateLines", methodDesc, false));
